...
class PlayerCar:
    def __init__(self):
        ...
        self.speed = 5
        # Create a simple car image for player
        self.image = pygame.Surface((self.width, self.height))
        self.image.fill(RED)
        # Add simple details to the car image
        pygame.draw.rect(self.image, BLACK, (10, 10, 30, 20))  # windshield
        pygame.draw.rect(self.image, BLACK, (5, 80, 15, 10))   # left wheel
        pygame.draw.rect(self.image, BLACK, (30, 80, 15, 10))  # right wheel
...
class OpponentCar:
    def __init__(self):
        self.width = 50
        self.height = 100
        # Spawn anywhere on the road width randomly
        self.x = random.randint(50, WIDTH - 50 - self.width)
        self.y = -self.height
        self.speed = random.randint(3, 7)
        # Create a simple car image for opponent
        self.image = pygame.Surface((self.width, self.height))
